...
// Get Enquiries count
$sql_enq = "SELECT id from tblenquiry";
$query_enq = $dbh->prepare($sql_enq);
$query_enq->execute();
$enquiries_count = $query_enq->rowCount();

// Get Registered users count
$sql_users = "SELECT id from tblusers";
$query_users = $dbh->prepare($sql_users);
$query_users->execute();
$users_count = $query_users->rowCount();

// Get Bookings count
$sql_bookings = "SELECT BookingId from tblbooking";
$query_bookings = $dbh->prepare($sql_bookings);
$query_bookings->execute();
$bookings_count = $query_bookings->rowCount();
?>
	...
	<div class="container">
		<div class="col-md-4 routes-left wow fadeInRight animated" data-wow-delay=".5s">
			...
			<div class="rou-rgt wow fadeInDown animated" data-wow-delay=".5s">
				<h3><?php echo number_format($enquiries_count); ?></h3>
				<p>Enquiries</p>
			</div>
				<div class="clearfix"></div>
		</div>
		...
		<div class="col-md-4 routes-left wow fadeInRight animated" data-wow-delay=".5s">
			...
			<div class="rou-rgt">
				<h3><?php echo number_format($bookings_count); ?></h3>
				<p>Booking</p>
			</div>
				<div class="clearfix"></div>
		</div>
